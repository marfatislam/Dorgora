...
<script>
    window.addEventListener('load', function(){
        ...
        jQuery('#arcontactus_form_twilio_on,#arcontactus_form_tg_on,#arcontactus_form_onesignal_on,#arcontactus_form_email_on,#arcontactus_form_perfex_on').change(function(){
