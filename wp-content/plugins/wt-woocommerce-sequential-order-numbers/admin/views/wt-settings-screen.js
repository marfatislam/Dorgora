(function( $ ) {
	...
	function wt_sample_order_number()
	{
		...
		{
			$('#wt_sequence_order_number_sample-description').html('<span style="color:#646970; padding-left:235px; font-size :14px; font-weight:500;">'+text+start_num+'</span>');
		}
		if( start_num && prefix && format =='[prefix][number]')
		{
			$('#wt_sequence_order_number_sample-description').html('<span style="color:#646970; padding-left:235px; font-size :14px; font-weight:500;">'+text+prefix+start_num+'</span>');
		}
		if(date && start_num && format =='[date][number]')
		{
			$('#wt_sequence_order_number_sample-description').html('<span style="color:#646970; padding-left:235px; font-size :14px; font-weight:500;">'+text+date+start_num+'</span>');
		}
		if(date && start_num && prefix && format =='[prefix][date][number]')
		{
			$('#wt_sequence_order_number_sample-description').html('<span style="color:#646970; padding-left:235px; font-size :14px; font-weight:500;">'+text+prefix+date+start_num+'</span>');
		}	
	}
