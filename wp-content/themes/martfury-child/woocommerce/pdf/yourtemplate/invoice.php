...
<table class="head container">
	<tr>
        ...
        <td class="header_1">
            ...
            <img src="https://dorgora.com/wp-content/uploads/2021/04/Bkash_QR_code.png" >
...
<table class="order-details">
	<thead>
		<tr>
            ...
            <th class="unit_price"><?php _e('Unit Price', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
	...
	<tbody>
		...
		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
            ...
            <td class="unit_price"><?php echo $item['ex_single_price']; ?></td>
